...
export default function LogisticsPage() {
  return (
    <div className="min-h-screen bg-[#F9F7F2] py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* Header */}
        <div className="mb-14">
          <p className="text-[9px] tracking-[0.35em] uppercase text-[#D4AF37] font-semibold mb-4">
            Logistics Transparency
          </p>
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-[#1B1F23] leading-tight mb-4">
            The Most Transparent<br />Caterer in Malaysia.
          </h1>
          <p className="text-[#1B1F23]/55 max-w-2xl leading-relaxed">
        ...
        {/* 3 feature cards */}
        <div className="grid sm:grid-cols-3 gap-px bg-[#1B1F23]/6 mb-14">
          {[
            ...
            <div key={title} className="card-glass p-7 hover:shadow-md transition-all">
              <div className="w-10 h-10 border border-[#D4AF37]/30 flex items-center justify-center mb-5">
                <Icon className="w-4.5 h-4.5 text-[#D4AF37]" />
              </div>
              <h3 className="font-semibold text-[#1B1F23] text-sm mb-2">{title}</h3>
              <p className="text-[#1B1F23]/45 text-sm leading-relaxed">{body}</p>
            </div>
          ))}
        </div>
        ...
        <div className="mb-16">
          <div className="flex items-end justify-between mb-6">
            <div>
              <p className="text-[9px] tracking-[0.3em] uppercase text-[#D4AF37] font-semibold mb-2">
                Interactive
              </p>
              <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#1B1F23]">
                Venturas Impact Map
              </h2>
            </div>
            <p className="text-xs text-[#1B1F23]/35 hidden sm:block">
        ...
        <div className="mb-16">
          <div className="mb-6">
            ...
            <h2 className="font-serif text-2xl md:text-3xl font-bold text-[#1B1F23] mb-2">
              Your Private Live Tracker
            </h2>
            <p className="text-[#1B1F23]/45 text-sm max-w-xl">
        ...
        <div className="card-glass p-8 mb-14">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div>
              <p className="text-[9px] tracking-[0.3em] uppercase text-[#D4AF37] font-semibold mb-3">
                Distance-Based Pricing
              </p>
              <h3 className="font-serif text-2xl font-bold text-[#1B1F23] mb-4">
                Transport Fees Calculated<br />from Your Venue Address.
              </h3>
              <p className="text-[#1B1F23]/55 text-sm leading-relaxed mb-6">
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={row.zone} className="flex justify-between items-center py-2.5 border-b border-[#1B1F23]/6 last:border-0 text-sm">
                  <div>
                    <span className="text-[#1B1F23]">{row.zone}</span>
                    <span className="text-[#1B1F23]/35 text-xs ml-2">({row.km})</span>
                  </div>
                  <span className="font-semibold text-[#D4AF37]">{row.fee}</span>
                </div>
              ))}
            </div>
          </div>
