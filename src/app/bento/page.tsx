...
export default function BentoPage() {
  return (
    <div data-theme="bento" className="min-h-screen bg-[#F9F7F2] py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <p className="text-[9px] tracking-[0.35em] uppercase text-[#D4AF37] font-semibold mb-4">
            Interactive Tool
          </p>
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-[#1B1F23] mb-3">
            Build Your Bento Box
          </h1>
          <p className="text-[#1B1F23]/55 max-w-xl mx-auto">
            Drag and assemble your ideal bento. See live pricing. Share the link with your team
            for approval before placing your order.
          </p>
          <p lang="ms" className="text-[#1B1F23]/35 text-sm italic mt-1">
